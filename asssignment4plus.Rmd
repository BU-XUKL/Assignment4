...
Next I'll use Task two method to analysis the sentence. I will seperate the words from each sentence and compare to which just use function sentiment_by().
